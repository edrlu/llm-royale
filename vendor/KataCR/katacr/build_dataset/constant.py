...
_env_dataset = os.environ.get("KATACR_DATASET_PATH")
_repo_vendor_dataset = root.parent / "vendor" / "Clash-Royale-Detection-Dataset"
path_dataset = Path(_env_dataset).expanduser() if _env_dataset else _repo_vendor_dataset
