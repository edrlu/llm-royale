...
from ultralytics.utils.ops import torch, xywh2xyxy

try:
    from ultralytics.utils.ops import nms_rotated
except ImportError:  # ultralytics>=8.3 no longer exposes this symbol here
    def nms_rotated(*args, **kwargs):
        raise NotImplementedError("rotated NMS is unavailable in this ultralytics build")
